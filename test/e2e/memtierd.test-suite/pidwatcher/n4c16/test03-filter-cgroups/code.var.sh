...
echo -e "\n=== scenario 1: test filter/cgroups with policy-age and multi-tracker (softdirty and idlepage) ===\n"
MEMTIERD_YAML="
policy:
  name: age
  config: |
...
echo -e "\n=== scenario 2: test filter/cgroups with policy-heat and multi-tracker (softdirty and idlepage) ===\n"
MEMTIERD_YAML="
policy:
  name: heat
  config: |
...
echo -e "\n=== scenario 3: test filter/cgroups (negative case) with policy-age and multi-tracker (softdirty and idlepage) ===\n"
MEMTIERD_YAML="
policy:
  name: age
  config: |
